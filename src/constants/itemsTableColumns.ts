export const itemsTableColumns = [
    {keyColumn:'codigo',label:'codigo',searchable:true,filterable:false,visible:false},
    {keyColumn:'titulo',label:'titulo',searchable:true,filterable:false,visible:false},
    {keyColumn:'cbTitulos',label:'cbTitulos',searchable:true,filterable:false,visible:false},
    {keyColumn:'cbItemSkus',label:'cuenta',searchable:false,filterable:true,visible:false},
